...
export const INSTRUMENTS = {
  stocks: [
    { id: 'AAPL',  name: 'Apple Inc.',            price: 339.75, vol: 0.018, sector: 'Technology',   color: '#00d4ff' },
    { id: 'MSFT',  name: 'Microsoft Corp.',        price: 498.00, vol: 0.016, sector: 'Technology',   color: '#a855f7' },
    { id: 'NVDA',  name: 'NVIDIA Corp.',           price: 228.87, vol: 0.030, sector: 'Technology',   color: '#00ff88' },
    { id: 'GOOGL', name: 'Alphabet Inc.',          price: 351.16, vol: 0.017, sector: 'Technology',   color: '#ffb347' },
    { id: 'AMZN',  name: 'Amazon.com Inc.',        price: 254.98, vol: 0.020, sector: 'Consumer',     color: '#ff6b9d' },
    { id: 'META',  name: 'Meta Platforms Inc.',    price: 589.48, vol: 0.022, sector: 'Technology',   color: '#00d4ff' },
    { id: 'TSLA',  name: 'Tesla Inc.',             price: 378.90, vol: 0.040, sector: 'Automotive',   color: '#ff4757' },
  ...
  crypto: [
    { id: 'BTC',  name: 'Bitcoin',       price: 86422.00, vol: 0.025, sector: 'Crypto', color: '#ffb347' },
    { id: 'ETH',  name: 'Ethereum',      price: 2761.37,  vol: 0.030, sector: 'Crypto', color: '#a855f7' },
    { id: 'SOL',  name: 'Solana',        price: 118.81,   vol: 0.045, sector: 'Crypto', color: '#00ff88' },
    { id: 'BNB',  name: 'BNB',           price: 790.56,   vol: 0.022, sector: 'Crypto', color: '#ffb347' },
    { id: 'AVAX', name: 'Avalanche',     price: 11.13,    vol: 0.050, sector: 'Crypto', color: '#ff4757' },
  ],
  forex: [
    { id: 'EUR/USD', name: 'Euro / US Dollar',      price: 1.1463, vol: 0.004, sector: 'Forex', color: '#00d4ff' },
    { id: 'GBP/USD', name: 'British Pound / USD',   price: 1.3363, vol: 0.005, sector: 'Forex', color: '#a855f7' },
    { id: 'USD/JPY', name: 'US Dollar / Japanese Yen', price: 157.18, vol: 0.003, sector: 'Forex', color: '#00ff88' },
    { id: 'USD/CHF', name: 'US Dollar / Swiss Franc',  price: 0.8920, vol: 0.004, sector: 'Forex', color: '#ffb347' },
  ],
  commodities: [
    { id: 'XAU/USD', name: 'Gold (Spot / USD)', price: 4354.06, vol: 0.012, sector: 'Commodities', color: '#fbbf24' },
    { id: 'XAG/USD', name: 'Silver (Spot / USD)', price: 51.53, vol: 0.022, sector: 'Commodities', color: '#cbd5e1' },
  ],
};
